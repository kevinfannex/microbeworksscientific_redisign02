  ...
  return (
    ...
    >
      <div className="max-w-[1100px] w-full">
        ...
        <h1 className="text-[2.5rem] md:text-[3.5rem] lg:text-[4.2rem] font-display font-medium tracking-tight mb-8 md:mb-10 contact-reveal text-accent2">
          Contact
        </h1>
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-16">
          ...
          <div className="relative contact-reveal w-full lg:max-w-[520px]">
            ...
            <div className="absolute -inset-3 bg-accent2/10 dark:bg-accent2/20 blur-[40px] rounded-[40px] pointer-events-none opacity-50 dark:opacity-100" />
                ...
                <div className="space-y-6 pt-8 border-t border-border-default">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 mt-3 text-[0.85rem] font-mono text-accent hover:text-accent2 hover:underline transition-colors font-semibold"
                    >
          ...
          {/* Reach Us Info (Right) */}
          <div className="flex flex-col items-start pt-4 lg:pt-12 contact-reveal w-full lg:w-auto lg:min-w-[380px]">
            ...
            <div className="space-y-4">
              ...
              <a
                href="https://www.linkedin.com/company/microbeworks-scientific/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-[1.1rem] sm:text-[1.2rem] font-medium text-text-primary hover:text-accent transition-colors group !mt-2"
              >
                <svg
                  ...
                  className="text-[#0a66c2] group-hover:text-accent transition-colors w-5 h-5 shrink-0"
                >
