...
export default function ProductsSection() {
  ...
  return (
    <section
      id="products"
      ref={sectionRef}
      className="relative px-4 md:px-8 lg:px-12 py-24 md:pt-16 md:pb-32 bg-bg text-text-primary min-h-screen"
    >
      <div className="max-w-[1000px] mx-auto flex flex-col items-center">
        ...
        <div className="w-full reveal max-w-[900px] mx-auto">
          ...
          <div className="border border-border-default rounded-[20px] overflow-hidden bg-bg shadow-sm">
            ...
            {/* Row 1 */}
            <div className="grid grid-cols-[1.8fr_1fr_1fr_1.2fr] md:grid-cols-[1.2fr_1fr_1fr_1fr] items-center p-4 md:p-8 border-b border-border-default hover:bg-bg2 transition-colors">
            ...
            {/* Row 2 */}
            <div className="grid grid-cols-[1.8fr_1fr_1fr_1.2fr] md:grid-cols-[1.2fr_1fr_1fr_1fr] items-center p-4 md:p-8 hover:bg-bg2 transition-colors">
              <div className="flex items-center gap-2 md:gap-4">
