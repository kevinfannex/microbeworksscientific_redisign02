  ...
  return (
    ...
    >
      <div className="w-full max-w-[640px] relative z-10">
        {/* Title */}
        <h2 className="text-[2.2rem] md:text-[3rem] font-display font-medium tracking-tight mb-6 text-accent contact-reveal text-center">
          Contact
        </h2>
        ...
        <div className="w-full bg-[#181818] border border-white/5 rounded-2xl p-6 md:p-8 text-left shadow-2xl contact-reveal transition-colors duration-500 light-card-override">
          {/* Tagline */}
          <p className="text-white text-[1.1rem] md:text-[1.3rem] font-medium leading-snug mb-8 card-text-override">
          ...
          <div className="space-y-5 mb-8">
            <p className="text-white/60 text-sm font-semibold tracking-wide uppercase card-label-override">
              Reach us at
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:info@mws.bio" className="text-[1.25rem] md:text-[1.5rem] font-semibold text-accent3 hover:underline leading-none">
                info@mws.bio
              </a>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="tel:+918971126869" className="text-[1.25rem] md:text-[1.5rem] font-semibold text-white hover:underline leading-none card-link-override">
                8971126869
              </a>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.linkedin.com/company/microbeworks-scientific/" target="_blank" rel="noopener noreferrer" className="text-[1.25rem] md:text-[1.5rem] font-semibold text-white hover:underline leading-none card-link-override">
                LinkedIn
              </a>
            </div>
          </div>
